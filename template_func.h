...
extern ssize_t fd_tcp_recv_msg( int socket, char *recv_buf, size_t recv_len );
extern ssize_t fd_tcp_send_msg( int socket, char *send_buf, size_t send_len );
extern pthread_t
...
extern ssize_t fd_udp_recv_msg( int server_socket, char *recv_msg,
                                size_t recv_len );
extern ssize_t fd_udp_send_msg( int client_socket, char *send_buf,
                                size_t                    send_len,
